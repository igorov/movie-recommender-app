...
const Recommender = () => {
    ...
    const getRecommendations = async () => {
        ...
        const result = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/recommendation/movies?userId=${search}`)
    ...
    return (
        <div className="bg-indigo-100">
            ...
            <form id='search-form' onSubmit={(e) => { e.preventDefault(); getRecommendations(); }}>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="Search for user ID" required
                        value={search}
